  ...
  D.main_closure.prototype = {
    call$1: function(e) {
      ...
      if (t1 === "C") {
        ...
        if (typeof t2 !== "number")
          return H.iae(t2);
        (t1 && C.LabelElement_methods).setInnerHtml$1(t1, t3 + C.JSDouble_methods.toStringAsFixed$1(1.8 * t2 + 32, 3) + "\u5ea6");
      } else if (t1 === "F") {
        t1 = $.$get$output();
        t3 = "\u83ef\u6c0f" + H.S(t3) + "\u5ea6=\u651d\u6c0f";
        t2 = H.numTypeCheck($.number);
        if (typeof t2 !== "number")
          return t2.$sub();
        (t1 && C.LabelElement_methods).setInnerHtml$1(t1, t3 + C.JSDouble_methods.toStringAsFixed$1((t2 - 32) * 5 / 9, 3) + "\u5ea6");
      } else {
        t1 = $.$get$output();
        (t1 && C.LabelElement_methods).setInnerHtml$1(t1, "\u8acb\u8f38\u5165\u6578\u5b57\u52a0\u4e0a C \u6216 F!");
      }
      return;
    },
    $signature: 18
